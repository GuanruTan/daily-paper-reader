...
title_zh: Hamilton-Jacobi 框架下的无碰撞多智能体路径规划
...
## 摘要
我们提出了一种利用 Hamilton-Jacobi-Bellman (HJB) 方程进行无碰撞多智能体路径规划的方法。由于该方法植根于最优控制理论和偏微分方程，它避免了对分层规划器的需求，且不含黑盒组件。我们的模型可以处理异构智能体以及真实的、高维的动力学系统。我们开发了一种基于 Hamilton-Jacobi-Bellman 方程解的变分公式的无网格数值方法，即使在高维问题中也能求解最优轨迹，并提供了一些实际实现的注意事项。特别地，我们使用原始-对偶混合梯度优化方案来求解。我们在涉及简单车辆和四旋翼无人机的路径规划问题上证明了该方法的有效性。
